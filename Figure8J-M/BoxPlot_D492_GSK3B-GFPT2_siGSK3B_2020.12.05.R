funBoxPlot <- function(sheetName = "siRNA1-GSK3B", 
                       nr = 10, 
  ...
  setwd("C:/Users/lenovo/OneDrive - Háskóli Íslands/PC-HI/5 ProteomicPaper/Figures&Tables in the paper/ProteomicsManuscript_25.11.2020/Figures/Fig.Signaling/Panel7-8-siGSK3B-GFPT2")
  library(readxl)
  library(ggplot2)
  dat <- read_excel("siGSK3B-RNA-Expression-Summary-For-Plotting.xlsx", sheet = sheetName)
  dat <- data.frame(dat)
