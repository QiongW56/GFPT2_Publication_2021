funBoxPlot <- function(sheetName = "RNA1-GFPT2", 
                       nr = 18, 
  ...
  setwd("C:/Users/lenovo/OneDrive - Háskóli Íslands/PC-HI/4 Experiments documents_QIONG/14 Knockdowns Experiments/Results/25 MDA-MB-231/siGFPT2-FBS")
  library(readxl)
  library(ggplot2)
  dat <- read_excel("GeneExpression-MDAMB231.xlsx", sheet = sheetName)
  dat <- data.frame(dat)
 ...
 # CellType <- gsub("_.*", "", sheetName)
  ...
  setwd("C:/Users/lenovo/OneDrive - Háskóli Íslands/PC-HI/4 Experiments documents_QIONG/14 Knockdowns Experiments/Results/25 MDA-MB-231/siGFPT2-FBS/Figures")
